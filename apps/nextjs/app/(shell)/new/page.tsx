...
import { createBlogStream, fetchSessionStatus, fetchDefaultSavedVoice } from '@/lib/api';
...
export default function NewBlogPage(): React.ReactElement {
  ...
  // On fresh page load (refresh), auto-load default voice for authenticated users
  useEffect(() => {
